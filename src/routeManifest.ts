...
export const routeManifest: RouteMeta[] = [
  ...
  },
  {
    ...
    description: 'Release notes for Ledge for Mac, including the current v0.9.34 macOS 27 hover fix and links to the complete GitHub release history.',
    keywords: 'Ledge for Mac changelog, Ledge release notes, Ledge 0.9.34, macOS 27 hover fix',
    ogImage: '/og-image-en.png', ogAlt: 'Ledge for Mac public beta release notes', schema: 'article', lastmod: '2026-09-18', priority: 0.7, changefreq: 'weekly',
  },
  {
